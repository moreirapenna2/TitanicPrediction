...
import math
media=0
#debug = 1  >> rodar 20 vezes o algoritmo e tirar uma media do fitness total
debug=1

def exe():
        dataset=pd.read_csv('train.csv')
    	label=dataset.iloc[0:890,1] #separa o "survived" do dataset
    	data=dataset.iloc[0:890,[2,4,5,7]] #separa o "pclass" "sex" e "age" do dataset
    	x=[data]    
